...
5. Формулы приведения (В РАЗРАБОТКЕ)
: """)
try:
	if choice3 == '1':
		while True:
	...
	if choice3 == '2':
		while True:
			...
			if functionchoice == '1':
				tfunction1 = int(input('Введите значение синуса в градусах: '))
				sin()
			if functionchoice == '2':
				tfunction2 = int(input('Введите значение косинуса в градусах: '))
				cos()
			if functionchoice == '3':
				tfunction3 = int(input('Введите значение тангенса или котангенса в градусах: '))
				tgctg()
	if choice3 == '3':
		while True:
	...
	if choice3 == '5':
		while True:
			...
			functionnum2 = int(input('Введите значение угла: '))	
